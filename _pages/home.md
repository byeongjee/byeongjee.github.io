...
## News
- **Feb 2024**: My paper *Narrowing and Heuristic Search for Symbolic Reachability Analysis of Concurrent Object-Oriented Systems* is published in Science of Computer Programming ([doi](https://doi.org/10.1016/j.scico.2024.103097))
...
- **December 2022**: My paper *Symbolic Reachability Analysis of Distributed Systems using Narrowing and Heuristic Search* was published in FTSCS ([doi](https://dl.acm.org/doi/10.1145/3563822.3568017)).
